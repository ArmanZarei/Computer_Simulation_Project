...
class ServiceProvider:
    ...
    def has_empty_server(self) -> bool:
    ...
    def get_next_event_time(self):
        ...
        if self.has_empty_server() and not self.container.is_empty():
        ...
        services_earliest_time = min([np.inf] + [req.finish_service_time if req is not None else np.inf for req in self.services])
